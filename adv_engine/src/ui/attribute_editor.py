...
from ..core.data_schemas import AttributeGObject
...
class AttributeEditor(Gtk.Box):
    def __init__(self, project_manager):
        ...
        # Define columns
        self._create_column("ID", lambda attr: attr.id)
        self._create_column("Name", lambda attr: attr.name)
        self._create_column("Initial Value", lambda attr: str(attr.initial_value))
        self._create_column("Max Value", lambda attr: str(attr.max_value))
